...
import type {AuctionStructOutputERC20} from './types';

export class ReserveAuctionERC20 {
  public chainId: number;
  public contractAddress: string;
  public signerOrProvider: Signer | Provider;
  public contract: ReserveAuctionCoreErc20Type;
  ...
  constructor(
    ...
    if (contractAddress) {
      ...
      this.contractAddress = zoraAddresses[network].reserveAuctionCoreErc20;
    }
  ...
  ): Promise<AuctionStructOutputERC20> {
  ...
  // @param {string} payableAmount - input amount for ETH payable bid
  // @returns {Promise<ContractTransaction>}
