// reserveAuctionERC20.test.ts
// Jest test for ReserveAuctionERC20

import {
  AuctionInputDataERC20,
  AuctionStructERC20,
  ReserveAuctionERC20,
  wrapETH,
  ZoraModuleManager,
...
describe('Zora V3 ReserveAuctionERC20', () => {
  describe('constructor', () => {
    it('throws an error if no contract address is provided', () => {
      const wallet = Wallet.createRandom();

      expect(() => {
        new ReserveAuctionERC20(wallet, 420);
    ...
    it('throws an error if chainId does not map to a deployed instance', () => {
      ...
      expect(() => {
        new ReserveAuctionERC20(wallet, 69);
    ...
    it('throws an error if the contract address is not valid', () => {
      ...
      expect(() => {
        new ReserveAuctionERC20(wallet, 1, 'poop pee');
    ...
    it('sets the instance to readOnly if provider is specified', () => {
      ...
      const reserveAuction = new ReserveAuctionERC20(
        provider,
        4,
        zoraAddresses.rinkeby.reserveAuctionCoreErc20
      );
    ...
    it('initializes an instance with the checksummed address', () => {
      const wallet = Wallet.createRandom();
      const rinkebyAddress = zoraAddresses.rinkeby.reserveAuctionCoreErc20;
      const reserveAuction = new ReserveAuctionERC20(wallet, 4);
  ...
  describe('contract functions', () => {
    ...
    describe('write functions', () => {
      let defaultAuctionData: AuctionInputDataERC20;
      let defaultBidData: {
        amount: string;
      ...
      const setupTestActions = async (): Promise<{
        reserveAuction: ReserveAuctionERC20;
        erc721: Contract;
      ...
      const setupTestActionsBid = async (): Promise<{
        ...
        try {
          ...
          const {reserveAuction, erc721, moduleManager} =
