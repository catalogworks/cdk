// reserveAuctionFindersERC20.test.ts
// Jest test for ReserveAuctionFindersERC20

import {
  AuctionInputDataFindersERC20,
  AuctionStructFindersERC20,
...
describe('Zora V3 ReserveAuctionFindersERC20', () => {
  describe('constructor', () => {
    it('throws an error if no contract address is provided', () => {
      const wallet = Wallet.createRandom();

      expect(() => {
        new ReserveAuctionFindersERC20(wallet, 420);
    ...
    it('throws an error if chainId does not map to a deployed instance', () => {
      ...
      expect(() => {
        new ReserveAuctionFindersERC20(wallet, 69);
    ...
    it('sets the instance to readOnly if provider is specified', () => {
      ...
      const reserveAuction = new ReserveAuctionFindersERC20(
        provider,
        4,
        zoraAddresses.rinkeby.reserveAuctionsFindersErc20
      );
    ...
    it('initializes an instance with the checksummed address', () => {
      const wallet = Wallet.createRandom();
      const rinkebyAddress = zoraAddresses.rinkeby.reserveAuctionsFindersErc20;
      const reserveAuction = new ReserveAuctionFindersERC20(wallet, 4);
  ...
  describe('contract functions', () => {
    ...
    describe('write functions', () => {
      let defaultAuctionData: AuctionInputDataFindersERC20;
      let defaultBidData: {
        amount: string;
      ...
      beforeEach(async () => {
        ...
        defaultBidData = {
          ...
          tokenContractAddress: reserveAuctionConfig.erc721Test.address,
          tokenId: 1,
          finderAddress: mainWallet.address,
        };
      });
        ...
        it('throws an error on a read only instance', async () => {
          ...
          await expect(
            reserveAuction.createAuction(
              ...
              defaultAuctionData.findersFeeBPS
            )
        ...
        it('creates an auction', async () => {
          ...
          reserveAuction.contract.on(
            ...
            (
              ...
              tokenId: BigNumber,
              auction: AuctionStructFindersERC20
            ) => {
              ...
              expect(auction.findersFeeBps).toEqual(
                BigNumber.from(defaultAuctionData.findersFeeBPS)
              );
            }
          );
      ...
      describe('createBid', () => {
        ...
        // 03
        it('throws an error if the finders address is not valid', async () => {
          const reserveAuction = new ReserveAuctionFindersERC20(
            mainWallet,
            50,
            reserveAuctionConfig.reserveAuctionFindersERC20
        ...
        it('creates a bid', async () => {
          ...
          reserveAuction.contract.on(
            ...
            (
              ...
              expect(auction.currency).toEqual(defaultAuctionData.bidCurrency);
              expect(auction.finder).toEqual(defaultBidData.finderAddress);
            }
          );
