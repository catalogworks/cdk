// reserveAuctionFindersETH.test.ts
// Jest test for ReserveAuctionFindersETH

import {
  AuctionInputDataFindersETH,
  AuctionStructFindersETH,
...
describe('Zora V3 ReserveAuctionFindersETH', () => {
  describe('constructor', () => {
    it('throws an error if no contract address is provided', () => {
      const wallet = Wallet.createRandom();

      expect(() => {
        new ReserveAuctionFindersETH(wallet, 420);
    ...
    it('throws an error if chainId does not map to a deployed instance', () => {
      ...
      expect(() => {
        new ReserveAuctionFindersETH(wallet, 69);
    ...
    it('throws an error if the contract address is not valid', () => {
      ...
      expect(() => {
        new ReserveAuctionFindersETH(wallet, 1, 'poop pee');
  ...
  describe('contract functions', () => {
    ...
    describe('write functions', () => {
      let defaultAuctionData: AuctionInputDataFindersETH;
      let defaultBidData: {
        amount: string;
      ...
      const setupTestActions = async (): Promise<{
        reserveAuction: ReserveAuctionFindersETH;
        erc721: Contract;
        ...
        it('creates an auction', async () => {
          ...
          reserveAuction.contract.on(
            ...
            (
              ...
              tokenId: BigNumber,
              auction: AuctionStructFindersETH
            ) => {
      ...
      describe('createBid', () => {
        ...
        it('throws an error if finder address is not valid', async () => {
          const reserveAuction = new ReserveAuctionFindersETH(
            mainWallet,
            50,
            reserveAuctionConfig.reserveAuctionFindersETH
