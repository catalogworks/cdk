...
export interface IManifold extends BaseContract {
    ...
    functions: {
        getRoyalties(tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string[], BigNumber[]]>;
    };
    getRoyalties(tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string[], BigNumber[]]>;
    callStatic: {
        getRoyalties(tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string[], BigNumber[]]>;
    ...
    populateTransaction: {
        getRoyalties(tokenId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
