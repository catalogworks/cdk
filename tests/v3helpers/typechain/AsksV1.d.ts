...
export declare type AskStructOutput = [string, string, string, number, BigNumber] & {
    seller: string;
    sellerFundsRecipient: string;
    askCurrency: string;
...
export interface AsksV1Interface extends ethers.utils.Interface {
    functions: {
        ...
        "fillAsk(address,uint256,address)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "askForNFT", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "cancelAsk", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "createAsk", values: [string, BigNumberish, BigNumberish, string, string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "fillAsk", values: [string, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "name", values?: undefined): string;
    encodeFunctionData(functionFragment: "registrar", values?: undefined): string;
    encodeFunctionData(functionFragment: "setAskPrice", values: [string, BigNumberish, BigNumberish, string]): string;
...
export interface AsksV1 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AsksV1Interface;
    ...
    functions: {
        ...
        askForNFT(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            string,
            string,
            number,
        ...
        cancelAsk(_tokenContract: string, _tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        createAsk(_tokenContract: string, _tokenId: BigNumberish, _askPrice: BigNumberish, _askCurrency: string, _sellerFundsRecipient: string, _findersFeeBps: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        erc20TransferHelper(overrides?: CallOverrides): Promise<[string]>;
        erc721TransferHelper(overrides?: CallOverrides): Promise<[string]>;
        fillAsk(_tokenContract: string, _tokenId: BigNumberish, _finder: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        name(overrides?: CallOverrides): Promise<[string]>;
        registrar(overrides?: CallOverrides): Promise<[string]>;
        setAskPrice(_tokenContract: string, _tokenId: BigNumberish, _askPrice: BigNumberish, _askCurrency: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        cancelAsk(_tokenContract: string, _tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        createAsk(_tokenContract: string, _tokenId: BigNumberish, _askPrice: BigNumberish, _askCurrency: string, _sellerFundsRecipient: string, _findersFeeBps: BigNumberish, overrides?: CallOverrides): Promise<void>;
        erc20TransferHelper(overrides?: CallOverrides): Promise<string>;
        erc721TransferHelper(overrides?: CallOverrides): Promise<string>;
        fillAsk(_tokenContract: string, _tokenId: BigNumberish, _finder: string, overrides?: CallOverrides): Promise<void>;
        name(overrides?: CallOverrides): Promise<string>;
        registrar(overrides?: CallOverrides): Promise<string>;
        setAskPrice(_tokenContract: string, _tokenId: BigNumberish, _askPrice: BigNumberish, _askCurrency: string, overrides?: CallOverrides): Promise<void>;
        setRoyaltyEngineAddress(_royaltyEngine: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "AskCanceled(address,uint256,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, ask?: null): AskCanceledEventFilter;
        AskCanceled(tokenContract?: string | null, tokenId?: BigNumberish | null, ask?: null): AskCanceledEventFilter;
        "AskCreated(address,uint256,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, ask?: null): AskCreatedEventFilter;
        AskCreated(tokenContract?: string | null, tokenId?: BigNumberish | null, ask?: null): AskCreatedEventFilter;
        "AskFilled(address,uint256,address,address,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, buyer?: string | null, finder?: null, ask?: null): AskFilledEventFilter;
        AskFilled(tokenContract?: string | null, tokenId?: BigNumberish | null, buyer?: string | null, finder?: null, ask?: null): AskFilledEventFilter;
        "AskPriceUpdated(address,uint256,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, ask?: null): AskPriceUpdatedEventFilter;
        AskPriceUpdated(tokenContract?: string | null, tokenId?: BigNumberish | null, ask?: null): AskPriceUpdatedEventFilter;
    ...
    estimateGas: {
        ...
        askForNFT(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        cancelAsk(_tokenContract: string, _tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        createAsk(_tokenContract: string, _tokenId: BigNumberish, _askPrice: BigNumberish, _askCurrency: string, _sellerFundsRecipient: string, _findersFeeBps: BigNumberish, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        askForNFT(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        cancelAsk(_tokenContract: string, _tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        createAsk(_tokenContract: string, _tokenId: BigNumberish, _askPrice: BigNumberish, _askCurrency: string, _sellerFundsRecipient: string, _findersFeeBps: BigNumberish, overrides?: Overrides & {
