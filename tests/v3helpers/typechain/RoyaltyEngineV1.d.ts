...
export interface RoyaltyEngineV1Interface extends ethers.utils.Interface {
    ...
    encodeFunctionData(functionFragment: "royaltyRegistry", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "royaltyRegistry", data: BytesLike): Result;
...
export interface RoyaltyEngineV1 extends BaseContract {
    ...
    functions: {
        ...
        initialize(royaltyRegistry_: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(royaltyRegistry_: string, overrides?: CallOverrides): Promise<void>;
        owner(overrides?: CallOverrides): Promise<string>;
