...
export interface TestERC1155Interface extends ethers.utils.Interface {
    functions: {
...
export interface TestERC1155 extends BaseContract {
    ...
    functions: {
        ...
        mint(_to: string, _tokenID: BigNumberish, _amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        mintBatch(_to: string, _tokenIDs: BigNumberish[], _amounts: BigNumberish[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        balanceOfBatch(accounts: string[], ids: BigNumberish[], overrides?: CallOverrides): Promise<BigNumber[]>;
        isApprovedForAll(account: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
        mint(_to: string, _tokenID: BigNumberish, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        mintBatch(_to: string, _tokenIDs: BigNumberish[], _amounts: BigNumberish[], overrides?: CallOverrides): Promise<void>;
