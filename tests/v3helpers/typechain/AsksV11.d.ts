...
export interface AsksV11Interface extends ethers.utils.Interface {
    ...
    encodeFunctionData(functionFragment: "fillAsk", values: [string, BigNumberish, string, BigNumberish, string]): string;
...
export interface AsksV11 extends BaseContract {
    ...
    functions: {
        ...
        fillAsk(_tokenContract: string, _tokenId: BigNumberish, _fillCurrency: string, _fillAmount: BigNumberish, _finder: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        erc20TransferHelper(overrides?: CallOverrides): Promise<string>;
        erc721TransferHelper(overrides?: CallOverrides): Promise<string>;
        fillAsk(_tokenContract: string, _tokenId: BigNumberish, _fillCurrency: string, _fillAmount: BigNumberish, _finder: string, overrides?: CallOverrides): Promise<void>;
        name(overrides?: CallOverrides): Promise<string>;
        registrar(overrides?: CallOverrides): Promise<string>;
