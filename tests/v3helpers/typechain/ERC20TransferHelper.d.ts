...
export interface ERC20TransferHelper extends BaseContract {
    ...
    functions: {
        ...
        safeTransferFrom(_token: string, _from: string, _to: string, _value: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        ZMM(overrides?: CallOverrides): Promise<string>;
        isModuleApproved(_user: string, overrides?: CallOverrides): Promise<boolean>;
        safeTransferFrom(_token: string, _from: string, _to: string, _value: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
