...
export interface ReserveAuctionV1Interface extends ethers.utils.Interface {
    ...
    encodeFunctionData(functionFragment: "ZoraV1Market", values?: undefined): string;
    encodeFunctionData(functionFragment: "ZoraV1Media", values?: undefined): string;
    encodeFunctionData(functionFragment: "_handleRoyaltyEnginePayout", values: [string, BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "auctionForNFT", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "cancelAuction", values: [string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "createBid", values: [string, BigNumberish, BigNumberish, string]): string;
    ...
    encodeFunctionData(functionFragment: "setAuctionReservePrice", values: [string, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setRoyaltyEngineAddress", values: [string]): string;
    encodeFunctionData(functionFragment: "settleAuction", values: [string, BigNumberish]): string;
    decodeFunctionResult(functionFragment: "ZoraV1Market", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ZoraV1Media", data: BytesLike): Result;
...
export declare type AuctionDurationExtendedEventFilter = TypedEventFilter<AuctionDurationExtendedEvent>;
...
export interface ReserveAuctionV1 extends BaseContract {
    ...
    functions: {
        ...
        auctionForNFT(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            string,
            string,
            string,
        ...
        cancelAuction(_tokenContract: string, _tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        createAuction(_tokenContract: string, _tokenId: BigNumberish, _duration: BigNumberish, _reservePrice: BigNumberish, _sellerFundsRecipient: string, _findersFeeBps: BigNumberish, _auctionCurrency: string, _startTime: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        createBid(_tokenContract: string, _tokenId: BigNumberish, _amount: BigNumberish, _finder: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setAuctionReservePrice(_tokenContract: string, _tokenId: BigNumberish, _reservePrice: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setRoyaltyEngineAddress(_royaltyEngine: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        settleAuction(_tokenContract: string, _tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    ZoraV1Market(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        cancelAuction(_tokenContract: string, _tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        createAuction(_tokenContract: string, _tokenId: BigNumberish, _duration: BigNumberish, _reservePrice: BigNumberish, _sellerFundsRecipient: string, _findersFeeBps: BigNumberish, _auctionCurrency: string, _startTime: BigNumberish, overrides?: CallOverrides): Promise<void>;
        createBid(_tokenContract: string, _tokenId: BigNumberish, _amount: BigNumberish, _finder: string, overrides?: CallOverrides): Promise<void>;
        erc20TransferHelper(overrides?: CallOverrides): Promise<string>;
        erc721TransferHelper(overrides?: CallOverrides): Promise<string>;
        name(overrides?: CallOverrides): Promise<string>;
        registrar(overrides?: CallOverrides): Promise<string>;
        setAuctionReservePrice(_tokenContract: string, _tokenId: BigNumberish, _reservePrice: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setRoyaltyEngineAddress(_royaltyEngine: string, overrides?: CallOverrides): Promise<void>;
        settleAuction(_tokenContract: string, _tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "AuctionBid(address,uint256,uint256,address,bool,bool,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, amount?: BigNumberish | null, bidder?: null, firstBid?: null, extended?: null, auction?: null): AuctionBidEventFilter;
        AuctionBid(tokenContract?: string | null, tokenId?: BigNumberish | null, amount?: BigNumberish | null, bidder?: null, firstBid?: null, extended?: null, auction?: null): AuctionBidEventFilter;
        "AuctionCanceled(address,uint256,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, auction?: null): AuctionCanceledEventFilter;
        AuctionCanceled(tokenContract?: string | null, tokenId?: BigNumberish | null, auction?: null): AuctionCanceledEventFilter;
        "AuctionCreated(address,uint256,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, auction?: null): AuctionCreatedEventFilter;
        AuctionCreated(tokenContract?: string | null, tokenId?: BigNumberish | null, auction?: null): AuctionCreatedEventFilter;
        "AuctionDurationExtended(address,uint256,uint256,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, duration?: BigNumberish | null, auction?: null): AuctionDurationExtendedEventFilter;
        AuctionDurationExtended(tokenContract?: string | null, tokenId?: BigNumberish | null, duration?: BigNumberish | null, auction?: null): AuctionDurationExtendedEventFilter;
        "AuctionEnded(address,uint256,address,address,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, winner?: string | null, finder?: null, auction?: null): AuctionEndedEventFilter;
        AuctionEnded(tokenContract?: string | null, tokenId?: BigNumberish | null, winner?: string | null, finder?: null, auction?: null): AuctionEndedEventFilter;
        "AuctionReservePriceUpdated(address,uint256,uint256,tuple)"(tokenContract?: string | null, tokenId?: BigNumberish | null, reservePrice?: BigNumberish | null, auction?: null): AuctionReservePriceUpdatedEventFilter;
        AuctionReservePriceUpdated(tokenContract?: string | null, tokenId?: BigNumberish | null, reservePrice?: BigNumberish | null, auction?: null): AuctionReservePriceUpdatedEventFilter;
    ...
    estimateGas: {
        ...
        auctionForNFT(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        cancelAuction(_tokenContract: string, _tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        createAuction(_tokenContract: string, _tokenId: BigNumberish, _duration: BigNumberish, _reservePrice: BigNumberish, _sellerFundsRecipient: string, _findersFeeBps: BigNumberish, _auctionCurrency: string, _startTime: BigNumberish, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        auctionForNFT(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        cancelAuction(_tokenContract: string, _tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        createAuction(_tokenContract: string, _tokenId: BigNumberish, _duration: BigNumberish, _reservePrice: BigNumberish, _sellerFundsRecipient: string, _findersFeeBps: BigNumberish, _auctionCurrency: string, _startTime: BigNumberish, overrides?: Overrides & {
