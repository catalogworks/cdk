...
export interface TestEIP2981ERC721Interface extends ethers.utils.Interface {
    functions: {
...
export interface TestEIP2981ERC721 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestEIP2981ERC721Interface;
