...
export interface IRaribleV1 extends BaseContract {
    ...
    functions: {
        ...
        getFeeRecipients(id: BigNumberish, overrides?: CallOverrides): Promise<[string[]]>;
    };
    getFeeBps(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber[]>;
    getFeeRecipients(id: BigNumberish, overrides?: CallOverrides): Promise<string[]>;
    callStatic: {
    ...
    estimateGas: {
        getFeeBps(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getFeeRecipients(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        getFeeBps(id: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getFeeRecipients(id: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
