...
export interface IRaribleV2Interface extends ethers.utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getRaribleV2Royalties", values: [BigNumberish]): string;
...
export interface IRaribleV2 extends BaseContract {
    ...
    functions: {
        getRaribleV2Royalties(id: BigNumberish, overrides?: CallOverrides): Promise<[PartStructOutput[]]>;
    };
    getRaribleV2Royalties(id: BigNumberish, overrides?: CallOverrides): Promise<PartStructOutput[]>;
    callStatic: {
        getRaribleV2Royalties(id: BigNumberish, overrides?: CallOverrides): Promise<PartStructOutput[]>;
    ...
    filters: {};
    estimateGas: {
        getRaribleV2Royalties(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        getRaribleV2Royalties(id: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
