...
export interface ZoraModuleManagerInterface extends ethers.utils.Interface {
    ...
    encodeFunctionData(functionFragment: "isModuleApproved", values: [string, string]): string;
    encodeFunctionData(functionFragment: "moduleFeeToken", values?: undefined): string;
    encodeFunctionData(functionFragment: "moduleRegistered", values: [string]): string;
    encodeFunctionData(functionFragment: "registerModule", values: [string]): string;
    encodeFunctionData(functionFragment: "registrar", values?: undefined): string;
    encodeFunctionData(functionFragment: "setApprovalForModule", values: [string, boolean]): string;
    ...
    encodeFunctionData(functionFragment: "setBatchApprovalForModules", values: [string[], boolean]): string;
    encodeFunctionData(functionFragment: "setRegistrar", values: [string]): string;
    encodeFunctionData(functionFragment: "sigNonces", values: [string]): string;
    encodeFunctionData(functionFragment: "userApprovals", values: [string, string]): string;
...
export declare type ModuleRegisteredEvent = TypedEvent<[string], {
    module: string;
}>;
...
export interface ZoraModuleManager extends BaseContract {
    ...
    functions: {
        isModuleApproved(_user: string, _module: string, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        registerModule(_module: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        registrar(overrides?: CallOverrides): Promise<[string]>;
        setApprovalForModule(_module: string, _approved: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setApprovalForModuleBySig(_module: string, _user: string, _approved: boolean, _deadline: BigNumberish, _v: BigNumberish, _r: BytesLike, _s: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setBatchApprovalForModules(_modules: string[], _approved: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setRegistrar(_registrar: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        sigNonces(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        userApprovals(arg0: string, arg1: string, overrides?: CallOverrides): Promise<[boolean]>;
    };
    isModuleApproved(_user: string, _module: string, overrides?: CallOverrides): Promise<boolean>;
    moduleFeeToken(overrides?: CallOverrides): Promise<string>;
    moduleRegistered(arg0: string, overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        registrar(overrides?: CallOverrides): Promise<string>;
        setApprovalForModule(_module: string, _approved: boolean, overrides?: CallOverrides): Promise<void>;
        setApprovalForModuleBySig(_module: string, _user: string, _approved: boolean, _deadline: BigNumberish, _v: BigNumberish, _r: BytesLike, _s: BytesLike, overrides?: CallOverrides): Promise<void>;
        setBatchApprovalForModules(_modules: string[], _approved: boolean, overrides?: CallOverrides): Promise<void>;
        setRegistrar(_registrar: string, overrides?: CallOverrides): Promise<void>;
        sigNonces(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        userApprovals(arg0: string, arg1: string, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
        "ModuleApprovalSet(address,address,bool)"(user?: string | null, module?: string | null, approved?: null): ModuleApprovalSetEventFilter;
        ModuleApprovalSet(user?: string | null, module?: string | null, approved?: null): ModuleApprovalSetEventFilter;
        "ModuleRegistered(address)"(module?: string | null): ModuleRegisteredEventFilter;
        ModuleRegistered(module?: string | null): ModuleRegisteredEventFilter;
        "RegistrarChanged(address)"(newRegistrar?: string | null): RegistrarChangedEventFilter;
        RegistrarChanged(newRegistrar?: string | null): RegistrarChangedEventFilter;
    };
    estimateGas: {
        isModuleApproved(_user: string, _module: string, overrides?: CallOverrides): Promise<BigNumber>;
        moduleFeeToken(overrides?: CallOverrides): Promise<BigNumber>;
        moduleRegistered(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        registerModule(_module: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        ...
        sigNonces(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        userApprovals(arg0: string, arg1: string, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        isModuleApproved(_user: string, _module: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        moduleFeeToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        moduleRegistered(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        registerModule(_module: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        ...
        userApprovals(arg0: string, arg1: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
