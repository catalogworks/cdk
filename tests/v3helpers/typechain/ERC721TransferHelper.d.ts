...
export interface ERC721TransferHelperInterface extends ethers.utils.Interface {
    functions: {
...
export interface ERC721TransferHelper extends BaseContract {
    ...
    functions: {
        ...
        safeTransferFrom(_token: string, _from: string, _to: string, _tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        transferFrom(_token: string, _from: string, _to: string, _tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    ZMM(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ZMM(overrides?: CallOverrides): Promise<string>;
        isModuleApproved(_user: string, overrides?: CallOverrides): Promise<boolean>;
        safeTransferFrom(_token: string, _from: string, _to: string, _tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        transferFrom(_token: string, _from: string, _to: string, _tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
